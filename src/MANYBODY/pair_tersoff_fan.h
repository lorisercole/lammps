...
PairStyle(tersoff/fan,PairTersoffFan)

#else

#ifndef LMP_PAIR_TERSOFF_FAN_H
#define LMP_PAIR_TERSOFF_FAN_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTersoffFan : public Pair {
 public:
  PairTersoffFan(class LAMMPS *);
  virtual ~PairTersoffFan();
 ...
 protected:
  ...
  virtual void force_zeta(Param *, double, double, double &,
                          double &, int, double &);
  void attractive_fan(Param *, Param *, double, double, double, double, double,
  ...
  virtual void ters_zetaterm_d_fan(double, double, double, double *, double,
                                   double *, double, double *, Param *,
                                   Param *);
  void costheta_d_fan(double *, double, double *, double, double *);
